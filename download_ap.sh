...
curl -L -b /tmp/cookies "https://drive.google.com/uc?export=download&confirm=$(awk '/download/ {print $NF}' /tmp/cookies)&id=${https://drive.google.com/file/d/1wg8p5Z1Gw3qzUQnq9WYnBw1iLMmcBLD8/view?usp=sharing}" -o firmware/AP_A057F.tar.md5
